...
// 消息监听
window.onload = listenMessage
function listenMessage() {
  console.log('listenMessage')
  window.addEventListener('message', function (event) {
    acevieMessage(JSON.parse(event.data))
  })
}
function acevieMessage(data) {
...
function myPlaneBomb() {
  ...
  let msg = {info: 'game over', from: '2023 report game'}
